...
export const DefaultOTPVerificationValues = {
	...
	AuthTokenDefaultValue: "a51ed893f5b704c3927057d443930b65",
...
//Routes Values
export const DefaultRoutesValues = {
	AuthRoutes:{
		Signup:"signup",
		Login:"login",
		OTP:"otp"
...
export const DefaultMenuCreateValues = {
  ...
  //Client profile page default values
  export const DefaultClientProfilePageValues = {
	OrdersIcon:"Orders",
	VouchersIcon:"Vouchers",
	UserOptions: {
		Help:"Help",
		Language:"Language",
		Scan:"Scan",
 ...
 //Client Personal Info page default values
 export const DefaultPersonalInfoPageValues = {
	BackButton:"Back",
